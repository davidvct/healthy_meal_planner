...
The data model (Fig.~\ref{fig:er}) comprises the following entities:
\begin{enumerate}
...
MealVitals supports four primary use cases: (1)~managing health profiles, (2)~generating meal plans, (3)~retrieving shopping lists, and (4)~tracking health metrics. Fig.~\ref{fig:seq} presents the detailed interaction sequence for the meal plan autofill flow, which exercises the full stack from frontend through the CP-SAT solver.

\begin{figure}[htbp]
\centerline{\includegraphics[width=\columnwidth]{sequence.pdf}}
