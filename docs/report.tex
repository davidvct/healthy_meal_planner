...
\begin{abstract}
One in three Singapore residents live with chronic hyperlipidaemia or hypertension, a rate higher than the OECD average and one which remains stubbornly unchanged even as residents adopt healthier lifestyles post-COVID. We propose \textit{MealVitals}, a cloud-native Software-as-a-Service application that enables users to track nutritional intake, generate personalized meal plans, and produce grocery lists -- supporting every step of the dietary management journey.
\end{abstract}
...
\captionof{figure}{Sequence diagram for user registration.}
\label{fig:seq_reg}
\end{center}
...
\captionof{figure}{Sequence diagram for the meal plan auto-fill flow.}
\label{fig:seq_meal}
\end{center}
