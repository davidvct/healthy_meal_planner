    ...
    with recipes_path.open("r", encoding="utf-8-sig", newline="") as f:
        ...
        for idx, row in enumerate(reader, start=1):
            ...
            dish_record = {
                ...
                "saturatedFat": _parse_float(row.get("saturated_fat")),
                "transFat": _parse_float(row.get("trans_fat")),
                "netCarbs": _parse_float(row.get("net_carbs")),
                "vitaminC": _parse_float(row.get("vitamin_c")),
                "potassium": _parse_float(row.get("potassium")),
                "calcium": _parse_float(row.get("calcium")),
                "iron": _parse_float(row.get("iron")),
